 ...
 * @author LENOVO USERR
 */
public class login_minimarket extends javax.swing.JFrame {
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
            try{
        open_db();
        String sql =  "Select * from login_minimarket where username='"+user.getText()+"' and password='" + pass.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_minimarket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
